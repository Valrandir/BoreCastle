...
int BoreCastleMain()
{
	...
	Background bg_clouds(Background::TileMode::Top, 0, 0, 1.0, window->LoadImage(DATA_PATH "Cloud.png"));
	...
	Background bg_grass(Background::TileMode::Bottom, 0, 0, 1.0, window->LoadImage(DATA_PATH "Grass.png"));
	Background bg_ground(Background::TileMode::Bottom, 0, 0, 2.0, window->LoadImage(DATA_PATH "Ground.png"));
	Background bg_grass_front(Background::TileMode::Bottom, 0, 0, 3.0, window->LoadImage(DATA_PATH "GrassFront.png"));

	Background bg_left(Background::TileMode::Left, 0, 0, 1.0, window->LoadImage(DATA_PATH "RoundTest.png"));
	Background bg_right(Background::TileMode::Right, 0, 0, 1.0, window->LoadImage(DATA_PATH "RoundTest.png"));

	Image* img_sprite = window->LoadImage(DATA_PATH "Sprite.png");
	Sprite sprite_energy(img_sprite->Height(), img_sprite->Height(), img_sprite->Width() / img_sprite->Height(), img_sprite);
